...
for (const element of coursesAndDurationArray) {
    ...
    let courseText1=document.createElement('p');
    let courseText2=document.createElement('p');
    courseText1.innerText=('title:'+element.title);
    courseText2.innerText=('month duration:'+element.monthDuration);
    courseBlock.appendChild(courseText1);
    courseBlock.appendChild(courseText2);
...
for (const element of coursesAndDurationArray) {
    ...
    courseBlock.appendChild(paragraph);
    document.body.appendChild(courseBlock);
}
...
for (const member of simpsons) {
    ...
    memberBlock.style.background='silver';
    let nameHeader =document.createElement('h1');
    nameHeader.innerText=(member.name+' '+member.surname);
    let ageHeader=document.createElement('h3');
    ageHeader.innerText=('Age - '+member.age);
    let infoParagraph =document.createElement('p');
    infoParagraph.innerText=member.info;
    let memberPhoto=document.createElement('img');
    memberPhoto.src=member.photo
    memberBlock.appendChild(nameHeader);
    memberBlock.appendChild(ageHeader);
    memberBlock.appendChild(infoParagraph);
    memberBlock.appendChild(memberPhoto);
